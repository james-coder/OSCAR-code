...
const QList<QString> standardGraphOrder = {
    ...
    STR_GRAPH_Snore, STR_GRAPH_FlowAbnormality, STR_GRAPH_TidalVolume, STR_GRAPH_MaskPressure, STR_GRAPH_RespRate, STR_GRAPH_MinuteVent,
...
//    SG->AddLayer(new gDailySummary());
    ...
    const ChannelID cpapcodes[] = {
        ...
        BMC_PressureWave, BMC_FlowAbnormality
    };
